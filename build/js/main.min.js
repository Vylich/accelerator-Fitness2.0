...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    (0, _slider.checkReviewsSwiper)();
    (0, _slider.checkCoachSwiper)();
    (0, _tabs.showContent)();
    (0, _accordion.showAccordion)();
    (0, _accordion.showContentAccordion)();
    (0, _video.findVideos)();
...
},{"./modules/accordion":3,"./modules/form":4,"./modules/phone-mask.js":5,"./modules/slider.js":6,"./modules/tabs":7,"./modules/video":8,"./utils/ios-vh-fix":10,"./utils/reset-focus":11}],3:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.showContentAccordion = exports.showAccordion = void 0;
var buttons = document.querySelectorAll('[data-acc-tab]');
var lists = document.querySelectorAll('[data-acc-list]');
...
var showContentAccordion = function showContentAccordion() {
  headers.forEach(function (header) {
    header.insertAdjacentHTML('beforeEnd', '<button></button>');
    header.addEventListener('click', function () {
      header.blur();
      var activeContent = document.querySelector('#' + header.dataset.header);
...
exports.showContentAccordion = showContentAccordion;
...
var formNode = document.querySelector('.form__content');
...
},{"pristinejs":1}],5:[function(require,module,exports){
"use strict";
...
exports.checkCoachSwiper = checkCoachSwiper;
